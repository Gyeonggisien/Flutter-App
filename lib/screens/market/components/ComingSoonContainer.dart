        ...
        SingleChildScrollView(
          ...
          child: Row(
            ...
            children: [
              ...
              ComingSoonItem(dateText: '10.02 전환 예정', title: '백드롭페인팅 추상화(아이보리)',),
              ComingSoonItem(dateText: '10.04 전환 예정', title: '(공식수입) 사티아 인센스스틱 홀더 15g/100g ',),
              ComingSoonItem(dateText: '10.05 전환 예정', title: '백드롭페인팅 추상화(아이보리)',),
              SizedBox(width: getWidth(kDefaultPadding),),
            ],
          ),
        ),
